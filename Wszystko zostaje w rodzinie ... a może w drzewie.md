Git służy do śledzenia zmian w repozytorium więc czasem zdarza się że programiści pomimo usunięcia poufnych danych z repozytorium znajdują się one w jego drzewie.
